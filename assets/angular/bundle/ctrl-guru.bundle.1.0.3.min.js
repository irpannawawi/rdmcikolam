...
angular.module("RdmApp").controller("raporCtrl",["$scope","$rootScope","common","DTOptionsBuilder","DTColumnBuilder","$http","$q","ApiServer","FileUploader",function(a,e,t,s,l,i,n,o,r){a.dtInstance={},a.dataEdit={},a.setnaikKelas=function(a,t){console.log(a),console.log(t),$.blockUI({}),o.post("guru/walas/naikkelas/"+e.walas,{siswa_id:a,absen_siswanaik:t},(function(a){$.unblockUI({}),a.success?(e.getwalassiswa(),Swal.fire({type:"success",title:"Berhasil",showConfirmButton:!1,html:"Data Berhasil Disimpan",timer:1e3})):Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:a.message}).then((a=>{a.value&&e.getwalassiswa()}))}))},a.savedataEdit=function(){$(".edit-modal").modal("hide"),$.blockUI({}),o.post("guru/siswa/save",a.dataEdit,(function(e){$.unblockUI({}),e.success?(a.reloadTable(),Swal.fire({type:"success",title:"Berhasil",showConfirmButton:!1,html:"Data Berhasil Disimpan",timer:1e3})):Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:e.message}).then((a=>{a.value&&($(".edit-modal").modal("show"),$(".modal-dialog").draggable({handle:".modal-header"}))}))}))},a.dodataDelete=function(e){Swal.fire({type:"warning",title:"Perhatian",confirmButtonText:"Yes, delete it!",showCancelButton:!0,html:"Apakah Anda yakin akan menghapus data ini?"}).then((t=>{t.value&&($.blockUI({}),o.post("guru/siswa/delete",{siswa_id:e},(function(e){$.unblockUI({}),e.success?(a.reloadTable(),Swal.fire({type:"success",title:"Berhasil",showConfirmButton:!1,html:"Data Berhasil Dihapus",timer:1e3})):Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:e.message})})))}))},a.reloadTable=function(){e.datasiswa={},""!==a.selectData.kelas_id&&e.getdatasiswa(a.selectData)},a.cetakAllNilai=function(t){if(console.log(t),console.log(e.walassiswa.length),t<e.walassiswa.length)$.blockUI({message:"Proses generate nilai "+e.walassiswa[t].siswa_nama+", proses "+Math.round(100*(t+1)/e.walassiswa.length)+"%"}),o.get("guru/rapor/gennilaipdf/"+e.walassiswa[t].siswa_id,(function(e){$.unblockUI({}),e.success?a.cetakAllNilai(t+1):a.cetakAllNilai(t)}));else{var s=window.open("guru/rapor/downnilaipdf/"+e.walas,"_blank");s?(s.focus(),Swal.fire({type:"success",title:"Berhasil",showConfirmButton:!1,html:"Data digenerate",timer:2e3})):Swal.fire({type:"error",title:"Gagal",showConfirmButton:!1,html:"Ijinkan popup untuk mendownload",timer:2e3})}},a.cetakAllRapor=function(t){if(console.log(t),console.log(e.walassiswa.length),t<e.walassiswa.length)$.blockUI({message:"Proses generate rapor "+e.walassiswa[t].siswa_nama+", <br> Proses data "+(t+1)+" dari "+e.walassiswa.length+" siswa."}),o.get("guru/rapor/genraporpdf/"+e.walassiswa[t].siswa_id,(function(e){$.unblockUI({}),e.success?a.cetakAllRapor(t+1):a.cetakAllRapor(t)}));else{var s=window.open("guru/rapor/downraporpdf/"+e.walas,"_blank");s?(s.focus(),Swal.fire({type:"success",title:"Berhasil",showConfirmButton:!1,html:"Data digenerate",timer:2e3})):Swal.fire({type:"error",title:"Gagal",showConfirmButton:!1,html:"Ijinkan popup untuk mendownload",timer:2e3})}},a.dodataEdit=function(e){a.dataEdit=e,$(".edit-modal").modal("show"),$(".modal-dialog").draggable({handle:".modal-header"})},a.selectData={},a.selectData.kelas_id="",a.selectData.tingkat_id="",a.dtOptions=s.newOptions().withOption("searching",!0).withOption("stateSave",!0).withOption("paging",!0).withOption("responsive",!0).withOption("processing",!0).withOption("drawCallback",(function(){$(".lazy").Lazy();try{a.$apply()}catch(a){}})).withPaginationType("full_numbers");var u=a.uploader=new r({url:base_url+"guru/siswa/import"});a.berhasilaa=0,a.gandaaa=0,a.gagalaa=0,a.hapussemua=function(){u.clearQueue(),a.berhasilaa=0,a.gandaaa=0,a.gagalaa=0},u.filters.push({name:"customFilter",fn:function(a,e){return this.queue.length<100}}),u.filters.push({name:"imageFilter",fn:function(a,e){var t="|"+a.name.substr(a.name.lastIndexOf(".")+1)+"|";return console.info("type",t),-1!=="|xls|xlsx|".indexOf(t)}}),u.onSuccessItem=function(e,t,s,l){a.berhasilka=a.berhasilka+t.sukses,a.gandaaa=a.gandaaa+t.double1,a.gagalaa=a.gagalaa+t.gagal,a.$apply(),console.info("onSuccessItem",e,t,s,l,a.gandaaa)},u.onCompleteAll=function(){a.reloadTable()},u.onBeforeUploadItem=function(e){e.url=base_url+"guru/siswa/import?kelas_id="+a.selectData.kelas_id+"&tingkat_id="+a.selectData.tingkat_id},u.onAfterAddingAll=function(a){u.uploadAll()}}]);
